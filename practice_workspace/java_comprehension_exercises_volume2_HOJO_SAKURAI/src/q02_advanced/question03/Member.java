...
public class Member {
	...
	public static Member getInstance(int id, String password, String name, int age, int rank) {
		...
		q02_advanced.question02.Coupon coupon1 = q02_advanced.question02.Coupon.getInstance(1,0.5,"AAA");
		q02_advanced.question02.Coupon coupon2 = q02_advanced.question02.Coupon.getInstance(2,0.25,"BBB");
